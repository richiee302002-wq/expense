...
abstract class AppLocalizations {
  ...
  /// No description provided for @loginSetPin.
  ///
  /// In en, this message translates to:
  /// **'Set a 4-digit PIN'**
  String get loginSetPin;

  /// No description provided for @loginConfirmPin.
  ///
  /// In en, this message translates to:
  /// **'Confirm your PIN'**
  String get loginConfirmPin;

  /// No description provided for @loginPinMismatch.
  ///
  /// In en, this message translates to:
